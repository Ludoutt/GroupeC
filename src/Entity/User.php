...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\TaskComment", mappedBy="owner")
     */
    private $taskComments;

    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Task", mappedBy="assignee")
     */
    private $tasks;
    ...
    public function removeTaskComment(TaskComment $taskComment): self
    {
        if ($this->taskComments->contains($taskComment)) {
            ...
            if ($taskComment->getOwner() === $this) {
                $taskComment->setOwner(null);
            }
        }
    ...
    public function removeProject(Project $project): self
    {
        if ($this->projects->contains($project)) {
            ...
            // set the owning side to null (unless already changed)
            if ($project->getContributor() === $this) {
